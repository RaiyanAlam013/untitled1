...
public class TeacherShowFormMainframe extends JFrame{

        private JTextArea textArea;
        private JButton btn;
        private com.srps.gui.toolbar toolbar;
        private com.srps.gui.TextPanel textpanel;
        private TeacherShowFromPanel formpanel;
        public TeacherShowFormMainframe(dbase dataabase){
            super("Student Result processing System");
            setLayout(new BorderLayout());
            toolbar =new toolbar();
            textArea=new JTextArea();
            textpanel=new com.srps.gui.TextPanel();
            formpanel=new TeacherShowFromPanel(dataabase);
