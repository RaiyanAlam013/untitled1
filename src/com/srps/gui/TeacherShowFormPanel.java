...
public class TeacherShowFormPanel extends JPanel {
    ...
    public TeacherShowFormPanel(){
        Dimension dim=getPreferredSize();
        dim.width=585;
        setPreferredSize(dim);


        StudentIDLevel =new JLabel("StudentID: ");
        DepartmentLevel =new JLabel("DepartmentID: ");
        CourseIDLevel =new JLabel("CourseID: ");
        ...
        okBtn.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                teach.insertMarks(ID,Dept,Course,Mid,Final);
    ...
    public void setFormListner(FormEventListener Listener)
    {
